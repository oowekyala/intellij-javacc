...
class JJTSimpleExprParserState {
  ...
  public void openNodeScope(ASTNode n, Token firstToken) {
    marks.push(mk);
    mk = nodes.size();
   ...
   */
  public void closeNodeScope(ASTNode n, Token lastToken, int num) {
    mk = marks.pop();
    while (num-- > 0) {
      ASTNode c = popNode();
   ...
   */
  public void closeNodeScope(ASTNode n, Token lastToken, boolean condition) {
    if (condition) {
      int a = nodeArity();
      mk = marks.pop();
      while (a-- > 0) {
