...
public class JjtxLightPsi {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        System.out.println(StringUtil.formatFileSize(out.length()) + " and " + count + " classes written to " + out.getName());
    }
    ...
    private static boolean shouldAddEntry(String path) {
        ...
        return path.contains("/out/classes/production/") || path.contains("extensions.jar") || path.contains("openapi.jar") || path.contains("idea.jar");
    }

    private static void addJarEntry(JarOutputStream jarFile, String resourceName) throws IOException {
        InputStream stream = JjtxLightPsi.class.getClassLoader().getResourceAsStream(resourceName);
        if (stream == null) {
