        ...
        changeNotes(
            """
                ...
                <ul>
                    ...
                    usage in *.jj files raise an error and a suggestion to rename the file.</li>
                    ...
                    <ul>
                        ...
                        <!--<li>TODO link from a *.jj file to its *.jjt file</li>-->
                        <li>Completion suggestions for regex productions.</li>
                        <li>Prettier icons, based on the official JavaCC logo and following the IntelliJ UI guidelines</li>
                        <li>Folding of code generated by JJTree in .jj files (@bgen sections)</li>
                        <li>Find usages, completion, and summary documentation for lexical states</li>
                        <li>All tokens now have a link in documentation of BNF expansions</li>
                        <!--TODO <li>Some quickfixes for semantic errors</li> -->
