...
class LookaheadIsNotAtChoicePointInspection : JccInspectionBase(DisplayName) {
    ...
    override fun getStaticDescription(): String = """
        ...
        <p>There are 4 different kinds of choice points in JavaCC, of the following forms:
            <ul>
            ...
            is in the middle of the sequence. More information about the choice calculation and
            what a choicepoint is is available on the official <a href="https://javacc.org/tutorials/lookahead">Lookahead Tutorial</a>.</p>
        <p>For nested lookahead specifications (e.g. <code>LOOKAHEAD(1, LOOKAHEAD(2, a()) a() | Foo()) Foo()</code>),
        the syntactic lookahead is not evaluated. Only the semantic lookahead is.</p>
    """.trimIndent()
