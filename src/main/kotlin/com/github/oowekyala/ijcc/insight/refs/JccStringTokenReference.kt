 ...
 *
 * If there exists a [JccRegexprSpec] defined as *exactly* this string, the reference
 ...
 * [JccRegexpExpansionUnit] generating it.
 *
...
class JccStringTokenReference(element: JccLiteralRegexpUnit) :
    ...
    /**
     * The returned array contains either a single [JccRegexpExpansionUnit] ([SyntheticToken])
     * or one or more [JccRegexprSpec] ([ExplicitToken]). This is because a synthetic token is
