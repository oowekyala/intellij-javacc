...
enum class JccIcons(icon: Icon) : Icon by icon {
    ...
    constructor(fname: String) : this(IconLoader.getIcon(fname, JccIcons::class.java))

    companion object {
        fun default(): Icon = IconLoader.getIcon("jjtreeNodeLocate.svg", JccIcons::class.java)
    }
}
