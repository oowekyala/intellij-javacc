 ...
 */
@Suppress("ClassName")
sealed class JjtOption<T : Any>(override val type: OptionType<T>, override val staticDefaultValue: T?)
    : GenericOption<T> {
    ...
    object BUILD_NODE_FILES : JjtOption<Boolean>(OptionType.BOOLEAN, true)

    /**Generate a multi mode parse tree. The default for this is false, generating a simple mode parse tree.*/
    object MULTI : JjtOption<Boolean>(OptionType.BOOLEAN, false)

    /**Instead of making each non-decorated production an indefinite node, make it void instead.*/
    object NODE_DEFAULT_VOID : JjtOption<Boolean>(OptionType.BOOLEAN, false)
    ...
    object NODE_CLASS : JjtOption<String>(OptionType.STRING, "")
     ...
     */
    object NODE_FACTORY : JjtOption<String>(OptionType.STRING, "")

    /**
     * The package to generate the node classes into. The default for this is the parser package.
     */
    object NODE_PACKAGE : JjtOption<String>(OptionType.STRING, null) {
     ...
     */
    object NODE_USES_PARSER : JjtOption<Boolean>(OptionType.BOOLEAN, false)
     ...
     */
    object TRACK_TOKENS : JjtOption<Boolean>(OptionType.BOOLEAN, false)
     ...
     */
    object STATIC : JjtOption<Boolean>(OptionType.BOOLEAN, true)
     ...
     */
    object VISITOR : JjtOption<Boolean>(OptionType.BOOLEAN, false)
     ...
     */
    object VISITOR_DATA_TYPE : JjtOption<String>(OptionType.STRING, "Object")
    ...
    object VISITOR_RETURN_TYPE : JjtOption<String>(OptionType.STRING, "Object")

    /**If this option is set, it is used in the signature of the generated jjtAccept() methods and the visit() methods.*/
    object VISITOR_EXCEPTION : JjtOption<String>(OptionType.STRING, "")
     ...
     */
    object JJTREE_OUTPUT_DIRECTORY : JjtOption<String>(OptionType.STRING, null) {
